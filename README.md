...
Current release: **0.3.23**

| Need | Download | Purpose |
| --- | --- | --- |
| Android APK | `VRCMomo-v0.3.23.apk` in [Releases](https://github.com/Neil100o/VRCMomo/releases/latest) | Permanent-signature release. Future updates are checked through GitHub Releases. |
...
3. Verify that the bridge archive exists, then install the 0.3.23 release.
...
- Boop selector, in-app receive card and system notification. Version 0.3.23 fixes loss of emoji metadata from the legacy notification feed.
