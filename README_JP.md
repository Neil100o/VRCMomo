...
> **現在のテスト版：0.3.14**。端末・Android バージョン・再現手順・ログを添えて [Issues](https://github.com/Neil100o/VRCMomo/issues) へ報告してください。

## テスト版のダウンロード

- **Android APK：**[VRCMomo-v0.3.14.apk](downloads/VRCMomo-v0.3.14.apk) — Android 端末へダウンロードし、確認画面でブラウザまたはファイルマネージャーからのインストールを許可して導入してください。
