...
> **当前测试版本：0.3.11**。欢迎通过 [Issues](https://github.com/Neil100o/VRCMomo/issues) 反馈问题、设备信息和复现步骤。

## 测试版下载

- **Android 安装包：**[VRCMomo-v0.3.11.apk](downloads/VRCMomo-v0.3.11.apk) —— 下载到 Android 设备；系统提示时，允许浏览器或文件管理器安装未知来源应用后安装。
